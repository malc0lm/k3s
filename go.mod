...
replace (
	...
	k8s.io/kubelet => github.com/malc0lm/kubernetes/staging/src/k8s.io/kubelet v1.22.6-edge-1
	k8s.io/kubernetes => github.com/malc0lm/kubernetes v1.22.6-edge-1
...
require (
	...
	k8s.io/code-generator v0.22.6 // indirect
